...
int orange_f_time = 1030;
int yellow_f_time = 1000; //900
int cross_f_time = 1600; //1550
...
void yello_team() {
  if ((distance_L < 110 or distance_L == 519) and flag == 0 and lai == 0 ) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 0) {
  ...
  //===============flag change==========
  if (distance_R > 280 and flag == 32 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (distance_R > 138 and distance_R <= 280 and flag == 32 and lai == 0) {
    PIDL2();
    pidtest_time = millis();
  } else if (flag == 32) {
    if (millis() - pidtest_time < 1000) {
  ...
  if ((distance_L > 165 or distance_L == 519) and flag == 33 and lai == 0 and lai3 == 0) {
    PIDF2();
    pidtest_time = millis();
  } else if (flag == 33 and lai3 == 0) {
    if (millis() - pidtest_time < 1000) {
      Motor_reset();
      lai = 1;
    } else {
  ...
  if ((millis() - pidtest_time < 3000) and flag == 33 and lai == 0 and lai3 == 1) {
    PIDB();
  } else if (distance_R < 135 and flag == 33 and lai == 0 and lai3 == 1) {
    PIDR2();
  ...
  if (relative_yaw - relative_yaw2 < 41 and flag == 35 and lai == 0) {
    LeftAround1();
    pidtest_time = millis();
  } else if (flag == 35) {// and
  ...
  if ((distance_R < 150 or distance_R == 519) and flag == 38 and lai == 0)
  {
    PIDR1();
    //  pidtest_time = millis();
  } else if ((distance_L > 270 and distance_R >= 150 or distance_R == 519) and flag == 38 and lai == 0) {
    PIDR2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_R > 68 and flag == 39 and lai == 0) {
    PIDF2();
    pidtest_time = millis();
  } else if (flag == 39) {
    if (millis() - pidtest_time < 1000) {
      Motor_reset();
      lai = 1;
    } else if (distance_L - distance_R > 2) {
      lai = 1;
      LeftAround2();
    } else if (distance_R - distance_L > 2) {
      lai = 1;
      RightAround2();
    } else {
      Motor_reset();
  ...
  if (relative_yaw - relative_yaw2 < 1 and flag == 40  and lai == 0) {
    LeftAround2();
    pidtest_time = millis();
  } else if (flag == 40) {
    Motor_reset();
...
void orange_team() {
  if ((distance_R < 150 or distance_R == 519 ) and flag == 0 and lai == 0) {
    PIDR1();
    pidtest_time = millis();
  } else if (flag == 0) {
    if (millis() - pidtest_time < 1000) {
...
//      digitalWrite(angle90, LOW);
  ...
  if ((distance_R > 160 or distance_R == 519) and flag == 33 and lai == 0 and lai3 == 0) {
    PIDF2();
    pidtest_time = millis();
  } else if (flag == 33 and lai3 == 0) {
    if (millis() - pidtest_time < 1000) {
  ...
  if ((millis() - pidtest_time < 3000) and flag == 33 and lai == 0 and lai3 == 1) {
    PIDB();
  } else if (distance_L < 120 and flag == 33 and lai == 0 and lai3 == 1) {
    PIDL2();
  } else if (flag == 33 and lai3 == 1) {
    if (millis() - pidtest_time < 4500) {
      Motor_reset();
  ...
  if ((distance_L < 130 or distance_L == 519) and flag == 38 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if ((distance_L < 220 and distance_L >= 130 or distance_L == 519) and flag == 38 and lai == 0) {
    PIDL2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
