...
void loop() {
  ...
  if (distance_L > 70 and flag == 5 and lai == 0) {
    PIDR1();
    pidtest_time = millis();
  } else if (flag == 5) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_R > 65 and flag == 7 and lai == 0) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 7) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_L > 70 and flag == 9 and lai == 0) {
    PIDR1();
    pidtest_time = millis();
  } else if (flag == 9) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_R > 65 and flag == 11 and lai == 0) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 11) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_R > 65 and flag == 15 and lai == 0) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 15) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_R > 65 and flag == 19 and lai == 0) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 19) {
    if (millis() - pidtest_time < 1000) {
  ...
  //---------------------------
  if (distance_R > 65 and flag == 23 and lai == 0) {
    PIDL1();
    pidtest_time = millis();
  } else if (flag == 23) {
    if (millis() - pidtest_time < 1000) {
