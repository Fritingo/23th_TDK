...
void yello_team() {
  ...
  if ((distance_L > 160 or distance_L == 519) and check_y == 0 and check_x == 0 and flag == 33 and lai == 0 and lai3 == 0) {
    PIDF2();
    //=================
    pidtest_time = millis();
...
//      digitalWrite(angle90, LOW);
  ...
  if ((distance_L < 130 or distance_L == 519) and flag == 38 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (((distance_L < 220 and distance_L >= 130) or (distance_L == 519 and STOP1==1)) and flag == 38) {
    PIDL2();
    pidtest_time = millis();
    STOP1=1;
  } else if (flag == 38) {
