...
void yello_team() {
  ...
  if (relative_yaw- relative_yaw2 < 42 and flag == 35 and lai == 0) {
    LeftAround1();
    pidtest_time = millis();
  } else if (flag == 35) {// and
  ...
  if (distance_R < 150 and flag == 38 and lai == 0 or distance_R == 519)
  {
    PIDR1();
    //  pidtest_time = millis();
  } else if ((distance_L > 280 and distance_R >= 150 and flag == 38 and lai == 0) or distance_R == 519) {
    PIDR2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
...
void orange_team() {
  ...
  if (relative_yaw - relative_yaw2 > -47 and flag == 35 and lai == 0) {
    RightAround1();
    pidtest_time = millis();
  } else if (flag == 35) {// and
    if (millis() - pidtest_time < 16000 and digitalRead(plus_ball_over_pin) == HIGH) {// or digitalRead(plus_ball_over_pin) == LOW
  ...
  if (distance_L < 130 and flag == 38 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (distance_R > 305 and distance_L >= 130 and flag == 38 and lai == 0) {
    PIDL2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
