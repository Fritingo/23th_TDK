...
int orange_f_time = 950;
int yellow_f_time = 900;
int cross_f_time = 1550;
...
void yello_team() {
  ...
  if (distance_R > 270 and flag == 32 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (distance_R > 135 and distance_R <= 270 and flag == 32 and lai == 0)
  {
    PIDL2();
    pidtest_time = millis();
  } else if (flag == 32) {
  ...
  if (distance_L > 165 and flag == 33 and lai == 0 or distance_L == 519) {
    PIDF2();
    pidtest_time = millis();
  }else if (flag == 33) {
    if (millis() - pidtest_time < 1000) {
 ...
 //       relative_yaw1 = relative_yaw2;
  ...
  if (distance_R < 150 and flag == 38 and lai == 0 or distance_R == 519)
  {
    PIDR1();
    //  pidtest_time = millis();
  } else if ((distance_R < 345 and distance_R >= 150 and flag == 38 and lai == 0) or distance_R == 519) {
    PIDR2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
...
void orange_team() {
  ...
  if (relative_yaw - relative_yaw2 < -1 and flag == 36 and lai == 0) {
    LeftAround1();
    pidtest_time = millis();
  } else if (flag == 36) {
    if (millis() - pidtest_time < 1000) {
  ...
  if (distance_L < 130 and flag == 38 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (distance_L < 220 and distance_L >= 130 and flag == 38 and lai == 0) {
    PIDL2();
    pidtest_time = millis();
  } else if (flag == 38) {
    if (millis() - pidtest_time < 1000) {
