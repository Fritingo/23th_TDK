...
void yello_team() {
  ...
  if ((distance_L > 160 or distance_L >= 500) and check_y == 0 and check_x == 0 and flag == 33 and lai == 0 and lai3 == 0) {
    ...
    if (millis() - pidtest_time < 1000) {
      ...
      if ((distance_L - distance_R > 3) and (distance_L < 500) and (distance_R < 500)) {
        lai = 1;
        LeftAround2();
      } else if ((distance_R - distance_L > 3) and (distance_L < 500) and (distance_R < 500)) {
        lai = 1;
        RightAround2();
      } else {
  ...
  if ((distance_R < 150 or distance_R >= 500) and flag == 38 and lai == 0)
  {
    PIDR1();
    //  pidtest_time = millis();
  } else if (((distance_L > 250 and distance_R >= 150) or (distance_R >= 500 and STOP1==1)) and flag == 38) {
    PIDR2();
    pidtest_time = millis();
    STOP1=1;
  } else if (flag == 38) {
  ...
  if (distance_R > 68 and flag == 39 and lai == 0) {
    ...
    if (millis() - pidtest_time < 1000) {
      Motor_reset();
      lai = 1;
    } else if ((distance_L - distance_R > 4) and (distance_L < 500) and (distance_R < 500)) {
      lai = 1;
      LeftAround2();
    } else if ((distance_R - distance_L > 4) and (distance_L < 500) and (distance_R < 500)) {
      lai = 1;
      RightAround2();
    } else {
      Motor_reset();
...
//      digitalWrite(angle90, LOW);
  ...
  if ((distance_R > 152 or distance_R >= 500) and check_y == 0 and check_x == 0 and flag == 33 and lai == 0 and lai3 == 0) {
    ...
    if (millis() - pidtest_time < 1000) {
      ...
      if ((distance_L - distance_R >= 4) and (distance_L < 500) and (distance_R < 500)) {
        lai = 1;
        LeftAround2();
      } else if ((distance_R - distance_L > 2) and (distance_L < 500) and (distance_R < 500)) {
        lai = 1;
        RightAround2();
      } else {
        //    relative_yaw_error = relative_yaw;
  ...
  if ((distance_L < 130 or distance_L >= 500) and flag == 38 and lai == 0)
  {
    PIDL1();
    pidtest_time = millis();
  } else if (((distance_L < 220 and distance_L >= 130) or (distance_L >= 500 and STOP1==1)) and flag == 38) {
    PIDL2();
    pidtest_time = millis();
    STOP1=1;
  } else if (flag == 38) {
