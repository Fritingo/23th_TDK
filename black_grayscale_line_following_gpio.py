...
ROIS = [ # [ROI, weight]
        (0, 0, 160, 120, 1), # You'll need to tweak the weights for your app
#        (0,  0, 160, 120, 1), # depending on how your robot is setup.
#        (0,   0, 160, 120, 1)
       ]
